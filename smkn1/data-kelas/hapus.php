...
<html>
<head>
	<title>Hapus Kelas | SMKN 1 Kota Bengkulu</title>
	<meta charset="utf-8">
		...
		<div class="row pt-3 justify-content-end">
			...
			<div class="konten pt-5 pl-5 pr-5" id="konten">
					...
					<div class="page-heading">
						<div>
							<h2><i class="fas fa-trash-alt"></i> Hapus Kelas</h2>
							<div class="breadcrumb-custom">
								<a href="../dashboard"><i class="fas fa-home"></i> Dashboard</a> / <a href="index.php">Data Kelas</a> / Hapus
							</div>
						</div>
					</div>
					...
					<div class="section-card">
						<div class="section-header">
							<h5><i class="fas fa-list"></i> Pilih Kelas yang Akan Dihapus</h5>
						</div>
							...
							<table class="table-custom display" id="dataTables" width="100%">
								...
								<tbody>
									...
									foreach ($dataKelas as $row) {
										...
										echo "<td><div class='form-check'><input class='form-check-input' type='checkbox' name='kode_kelas[]' value='" . $row['kode_kelas'] . "'></div></td>";
										echo "</tr>";
									}
									?>
								</tbody>
