...
<html>
<head>
	<title>Edit Guru | SMKN 1 Kota Bengkulu</title>
	<meta charset="utf-8">
		...
		<div class="row pt-3 justify-content-end">
			...
			<div class="konten pt-5 pl-5 pr-5" id="konten">
					...
					<div class="page-heading">
						<div>
							<h2><i class="fas fa-chalkboard-teacher"></i> Edit Guru</h2>
							<div class="breadcrumb-custom">
								<a href="../dashboard"><i class="fas fa-home"></i> Dashboard</a> / <a href="index.php">Data Guru</a> / Edit
							</div>
						</div>
					</div>
					...
					<div class="section-card">
						<div class="section-header">
							<h5><i class="fas fa-edit"></i> Form Edit Guru</h5>
						</div>
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										for ($i=0; $i < count($jkLabel) ; $i++) { 
											$checked = "";
											if ($dataGuru['jenis_kelamin'] == $jkValue[$i]) {$checked = "checked";}
