...
<html>
<head>
	<title>Hapus Admin | SMKN 1 Kota Bengkulu</title>
	<meta charset="utf-8">
		...
		<div class="row pt-3 justify-content-end">
			...
			<div class="konten pt-5 pl-5 pr-5" id="konten">
					...
					<div class="page-heading">
						<div>
							<h2><i class="fas fa-trash-alt"></i> Hapus Admin</h2>
							<div class="breadcrumb-custom">
								<a href="../dashboard"><i class="fas fa-home"></i> Dashboard</a> / <a href="index.php">Data Admin</a> / Hapus
							</div>
						</div>
					</div>
					...
					<div class="section-card">
						<div class="section-header">
							<h5><i class="fas fa-list"></i> Pilih Admin yang Akan Dihapus</h5>
						</div>
							...
							<table class="table-custom display" id="dataTables" width="100%">
								...
								<tbody>
									...
									foreach ($dataAdmin as $row) {
										...
										echo "<td><div class='form-check'><input class='form-check-input' type='checkbox' name='id_admin[]' value='" . $row['id_admin'] . "'></div></td>";
										echo "</tr>";
									}
									?>
								</tbody>
